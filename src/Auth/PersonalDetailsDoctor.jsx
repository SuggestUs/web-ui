...
import {
  validationForDoctorPesonlDetails,
  checkValues,
} from '../datavalidation/validationForData.js'
import AlertBox from '../Alert/Alert'

export default function PersonalDetailsDoctor() {
  const [dataFoePersonalDetails, setPersonalData] = useState(
    ObjForPersonalDetails
  )
  ...
  return (
    <div>
      {alert.display && (
        <AlertBox severity={alert.severityType} message={alert.message} />
      )}
